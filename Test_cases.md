...
| Test Case ID | Title                       | Description                                                          | Preconditions                    | Test Steps                                                       | Expected Result                                                 | Actual Result | Status | Comments |
|---------------|-----------------------------|----------------------------------------------------------------------|----------------------------------|------------------------------------------------------------------|---------------------------------------------------------------|---------------|--------|----------|
| **TC17**      | Multi-Browser Compatibility | Test main workflows on various browsers.                            | User has multiple browsers installed. | 1. Test login, cart, and checkout on Chrome, Firefox, Safari, and Edge. | UI and functionality are consistent across browsers.          |               |        |          |
